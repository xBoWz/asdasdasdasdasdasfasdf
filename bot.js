...
client.on('message', message => {
     if (message.content === (prefix + "asadsdasd")) {
...
---------------------
-هذا الرابط صالح ل 3 مستخدمين فقط
---------------------
...
if (message.content === 'رابط البوت') {
      message.author.send('https://discordapp.com/api/oauth2/authorize?client_id=472802928441294848&permissions=8&scope=bot').catch(e => console.log(e.stack));
...
client.on('message', message => {
    if (message.content.startsWith("+البوت")) {
...
client.on('message', message => {
  if (message.content.startsWith ("خخخخخخرانسششس")) {
...
client.on('message', msg => {
	const prefix = '+'
 if (msg.content.startsWith(prefix + 'ناتج')) {
...
client.on('message', message => {
    ...
    client.user.setAvatar(argresult);
	 ...
	 client.on("message", (message) => {
    if (message.content.startsWith("+بلع ")) {
...
client.on('message', message => {
	var prefix = "+";
  if (!message.content.startsWith(prefix)) return;
  const verifed = ["457015898637729812"];
if (message.content.startsWith(prefix + 'اونر')) {
